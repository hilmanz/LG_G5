                    ...
                    <div class="col-md-8 col-md-offset-2">
                        <div class="row text-center">
                            <div class="col-md-3 col-sm-3">
                                <a href="#" class="btn btn-game" onclick="rightChoose1();" id="choose1" alt="Yes/No">One handed photos<br>on the fly</a>
                            </div>
                            <div class="col-md-3 col-sm-3">
                                <a href="#" class="btn btn-game" onclick="wrongChoose1();" id="choose2" alt="Yes/No">One-touch 360<br>photo &amp; video</a>
                            </div>
                            <div class="col-md-3 col-sm-3">
                                <a href="#" class="btn btn-game" onclick="wrongChoose2();" id="choose3" alt="Yes/No">Dual wide angle 13 MP<br>&nbsp;</a>
                            </div>
                            <div class="col-md-3 col-sm-3">
                                <a href="#" class="btn btn-game" onclick="rightChoose2();" id="choose4" alt="Yes/No">Easy to access <br>shutter &amp; zoom button</a>
                            </div>
                        </div>
                    </div>    
                </div>
