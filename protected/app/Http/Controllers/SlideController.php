...
class SlideController extends Controller
{
    public function __construct(Request $request){
	 ...
	 ->paginate(10);
	 $articlenya="";
	 return view('admin.listslide', compact('articlenya','slide'));		 
	 }
	 ...
	 if(empty(Auth::user()->name)){
	  ...
	  $pages="list";
	  $select="image";
	  return view('admin.addslide', compact('pages','select'));
	 }
	 ...
	 public function store()
	 {
		  ...
		  if ($validator->fails()) {
			...
			if (Input::file('image')->isValid()) {	
			 ...
			 //Resize image @upload/slide/ to height 980, width654			  
			  ...
			  return Redirect::to('cms/list-slide');
			}
		  }
	  ...
	  return Redirect::to('cms/list-article')->withPesan('slide baru berhasil ditambahkan.');
	 }
		 ...
		 #Upload image
		  ...
		  if ($validator->fails()) {
			...
			if (Input::file('image')->isValid()) {	
			  ...
			  echo "failed";die;
			  Session::flash('error', 'uploaded file is not valid');
			  return Redirect::to('cms/list-article');
			}
		  }
		}
	 if ($input['type']=='video'){
