...
class ArticleController extends Controller
{
	...
	$article = DB::table('article')
	 ...
	 $articlenya = DB::table('article')->where('id_category', '1')->get();	

	
	 
	 $pages="list";
	
	 return view('admin.listartikel', compact('articlenya','article','slide','pages'));		 
	 }
	 ...
	 #Upload image
	  ...
	  return Redirect::to('cms/list-article')->withPesan('Artikel baru berhasil ditambahkan.');
	 }
	 ...
	 **/ 
	 public function update(Request $request, $id)
	 {
	  ...
	  if($_FILES['image']['name']!=''){
		...
		$input['event_date']=date('Y-m-d',strtotime($input['event_date']));
		$admin->update($input);  		
		return redirect('cms/list-article');    
	 }
