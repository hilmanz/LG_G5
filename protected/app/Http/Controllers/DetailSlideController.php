...
class DetailSlideController extends Controller
{
	...
	$pages="detail";
	 ...
	 $article = DB::table('article')->where('id_category','=','2')->get();
	  $pages="detail";
	  $select="image";
	  return view('admin.addslide', compact('article','pages','select'));
	 }
	 ...
	 public function store()
	 {
		 ...
		 #Upload image
		  ...
		  if ($validator->fails()) {
			...
			if (Input::file('image')->isValid()) {	
			  ...
			  return Redirect::to('cms/detail-article');
			}
		  }
	  ...
	  return Redirect::to('cms/detail-article')->withPesan('slide baru berhasil ditambahkan.');
	 }
	 ...
	 **/ 
	 public function edit($id)
	 {
		...
		$article = DB::table('article')->where('id_category','=','2')->where('n_status','=','1')->get();
				
		$pages="detail";	
		return view('admin.editslide', compact('article','slide','pages'));  			
	 }
	 ...
	 **/ 
	 public function incheckitall(Request $request, $id)
	 {
		...
		$admin = slide::findOrFail($id);    
		$admin->update($input);
		print json_encode(array('status'=>true,'id_article'=>$input['id_article']));    
	 }
	 ...
	 public function destroy($id)
	 {
		...
		return redirect('cms/detail-slide');  
	 }
